...
.content-container .logoz {
    width: 150%;
    margin-top: -170px; /* Adjust space below the logoz to separate from the next element */
}
...
.left-logo {
    ...
    margin-top: 30px; /* Move the logo further down */
}
...
<main>
    ...
    <img src="images/background-ott-png-33a2e5-224a47-0@3x.jpg" alt="Background" id="backgroundImage" style="margin-top: -90px; width: 100%; height: 700px;">
    </div>
    <div class="overlay-layer"></div>
    <div class="content-container">
        <img src="images/Netflix-Series-Logo-Vector-300x84-removebg-preview.png" alt="Gossip Girl" class="left-logo">
        <img src="images/AAAABVbOj0VpyHc5qBYFT9TCOICH_uzvm_-uY6qLqh3tNyCVQd2LE-REkJ3mV0yxtHS7Al26GK0QCE-sMSZu5rEebou0yJiVeNh1gW7cSUwlo_Wg.png" alt="Gossip Girl" class="logoz" width="100%">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            Labore suscipit incidunt quis beatae fugiat? 
            Cumque inventore eligendi eaque natus dolorem sint 
            architecto</p>
