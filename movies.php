...
.content-container .logoz {
    ...
    margin-top: -50px; 
    margin-bottom: 15px;
    margin-left: -215px;/* Adjust space below the logoz to separate from the next element */
}
...
<main>
    ...
    <img src="https://media.thv11.com/assets/KTHV/images/abbed1a8-0600-4ab7-926b-2c2333bb6318/abbed1a8-0600-4ab7-926b-2c2333bb6318_1920x1080.jpg" alt="Background" id="backgroundImage" style="margin-top: -90px; width: 100%; height: 700px;">
    </div>
    <div class="overlay-layer"></div>
    <div class="content-container">
        <img src="https://dnm.nflximg.net/api/v6/99PFSeD8sQZJBrGfVxGgWT8kG6s/AAAAQWMx42NF1jHNIDGQliBTck-UexWZ-QR90l42bc7Oqgy5N_YYokkrKmqyS4Qf6BTwB5nkGnJo0iCbZ0SgkAAhhSUp1AL0ZJ4fVvVQ1JX9uGBT9oNVm3ipc-EVN_9D0kuC9J1jkNO9h9VFs6sthhXa.png?r=4db" alt="Gossip Girl" class="logoz" width="100%">
