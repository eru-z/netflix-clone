...
<div class="browse-languages-container">
  <h2 class="browse-languages-title">Browse by Languages</h2>
  <form class="browse-languages-form">
    <div class="form-group">
      <label for="pref" class="form-label">Select Your Preferences</label>
...
/* Title Styles */
.browse-languages-title {
  color: white;
  font-size: 5px;
  font-weight: 200;
  margin-bottom: 100px; /* Added margin for spacing */
}

/* Form container */
.browse-languages-form {
  display: flex;
  justify-content: flex-start;  /* Align form items horizontally */
  gap: 30px;
  flex-wrap: wrap;  /* Wrap form items on smaller screens */
  align-items: center;
}
...
/* Button-like Hover Effect for Select */
.form-select:hover {
  border-color: #e50914;
  cursor: pointer;
}
